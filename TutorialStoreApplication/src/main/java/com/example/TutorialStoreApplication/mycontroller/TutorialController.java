package com.example.TutorialStoreApplication.mycontroller;
...
import com.example.TutorialStoreApplication.myservices.TutorialServices;
...
public class TutorialController {
	...
	public Optional<Tutorial> getTutorialById(@PathVariable("id") long id) {
		/*
		 * The TutorialRepository provides a method findById(). This method takes the id
		 * of the Tutorial to find. This method used to be findOne(). But since Spring
		 * data jpa 2.0 it's changed to findById().
		 */

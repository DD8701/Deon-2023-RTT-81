...
public class UserController {
	...
	/**
	 * In order to make code more readable it is good practice to use special DTOs
	 * for login It also make controllers less dependent from entities and separate
	 * validation from jpa functionality
	 */
	@GetMapping("/login")
